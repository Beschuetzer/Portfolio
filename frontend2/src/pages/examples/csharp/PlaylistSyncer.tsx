			...
			<React.Fragment>
				<CSharpCardSection>
					...
					<Paragraph size="four" classNameToAdd="margin-top-1">
						...
						month to no avail and realizing Google was in no hurry to fix the
						bug, I decided it would be an interesting programming exercise to
						create a simple application that could sync music and playlists to
						my phone.
					</Paragraph>
				</CSharpCardSection>
			</React.Fragment>,
