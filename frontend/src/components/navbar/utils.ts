import { ANIMATION_DURATION, HEADER_HEIGHT_CSS_PROPERTY_NAME, OVERFLOW_HIDDEN_CLASSNAME } from "../constants";
...
export const NAVBAR_DEFAULT_CLASSNAME = `${NAVBAR_CLASSNAME} ${NAVBAR_Z_INDEX_CLASSNAME} ${OVERFLOW_HIDDEN_CLASSNAME}`;
