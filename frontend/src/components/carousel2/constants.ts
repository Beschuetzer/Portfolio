...
export const CAROUSEL_PROGRESS_BAR_DIVIDER_WIDTH = 2;
export const CAROUSEL_PROGRESS_BAR_DOT_DIAMETER = 12;
...
export const CAROUSEL_PROGRESS_BAR_HEIGHT_MIN = 1;
export const CAROUSEL_PROGRESS_BAR_SCALE_AMOUNT_MULTIPLE_SECTIONS_DEFAULT = 5;
export const CAROUSEL_PROGRESS_BAR_SCALE_AMOUNT_ONE_SECTION_DEFAULT = 2;
