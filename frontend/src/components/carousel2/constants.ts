...
export const CLASSNAME__THUMBNAIL_BACKGROUND_COLOR = `${CLASSNAME__ROOT}-thumbnail-background-color`;
export const CLASSNAME__THUMBNAIL_TEXT_COLOR = `${CLASSNAME__ROOT}-thumbnail-text-color`;
