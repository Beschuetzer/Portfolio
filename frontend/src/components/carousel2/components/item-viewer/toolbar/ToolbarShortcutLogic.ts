...
import { CarouselItemViewerShortcuts, CarouselOptions, CarouselShortcut, CarouselShortcutOnActionCompleted } from "../../../types";

type GetAllKeysResponse = {
    [name in keyof CarouselItemViewerShortcuts]: KeyInput[];
}
type GetAllOnActionCompleted = {
    [name in keyof CarouselItemViewerShortcuts]: CarouselShortcutOnActionCompleted;
}
type GetAllResonse = {
    keys: GetAllKeysResponse;
    onActionCompleted: GetAllOnActionCompleted;
}
type GetIndividualResponse = Required<CarouselShortcut>;
export class ShortcutLogic {
    private _itemViewerShortcuts: CarouselItemViewerShortcuts;
    private _doNothing = () => null;
    
    private _closeShortcut: CarouselShortcut;
    private _nextItemShortcut: CarouselShortcut;
    private _pauseShortcut: CarouselShortcut;
    private _playShortcut: CarouselShortcut;
    private _previousItemShortcut: CarouselShortcut;
    private _seekBackwardsShortcut: CarouselShortcut;
    private _seekForwardsShortcut: CarouselShortcut;
