...
export const CARD_DEFAULT_CLASSNAME = `${CARD_CLASSNAME} ${CARD_CLASSNAME}--hoverable`;
export const CARD_DONE_CLASSNAME = `${CARD_CLASSNAME}--done`;
export const CARD_OPEN_CLASSNAME = `${CARD_CLASSNAME}--open`;
export const CARD_PLAYING_CLASSNAME = `${CARD_CLASSNAME}--playing`;
export const CARD_STOPPED_CLASSNAME = `${CARD_CLASSNAME}--stopped`;
