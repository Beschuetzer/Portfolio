...
export const BACK_END_ACHIEVEMENTS: Achievement[] = [
  {
    name: "Created a fully-customizable batcher service by pulling Twillio attributes at a defined interval and storing them in a PostgreSQL database, allowing the policy service to evaluate policies based on Twillio attributes without having to make calls itself.",
