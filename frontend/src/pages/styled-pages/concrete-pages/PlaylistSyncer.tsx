...
import { OS_10_ISSUE_TRACKER_URL, WIKIPEDIA_MTP_URL, WIKIPEDIA_DRM_URL, DOWNLOADER_URL } from '../../../components/constants';
...
export function PlaylistSyncer(props: PlaylistSyncerProps) {
  return (
    <ExamplePage sections={PLAYLIST_SYNCER_SECTIONS} />
  )
}