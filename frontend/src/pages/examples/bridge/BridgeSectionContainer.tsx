...
import {
  ...
  UDEMY_BOOTCAMP_URL,
  GITHUB_URL,
  BRIDGE_SECTION_CONTAINER_CLASSNAME,
...
type BridgeSectionContainerProps = {};

const sectionContents = [
  <SectionContainer
    index={0}
    name={bridgeSectionNames[0]}
  ...
  <SectionContainer
    index={1}
    name={bridgeSectionNames[1]}
    pageName={BRIDGE_PAGE_NAME}
  >
    <BridgeSection
      selectorToUseForSubtitle={(state: RootState) =>
        state.bridge.featureSectionTitle
      }
      titleSize="two"
      ...
      <CardManager>
        ...
        >
          <p>
            ...
            users to play on their Android phone or with the window only taking
            up a fraction of the screen.
          </p>
        </Card>
        <Card cardName="king-of-spades" title="Claim All" video={claimAllVideo}>
          <p>
            ...
            than play them out. &nbsp;It does this by showing he claimer's cards
            to the two defensive players.&nbsp; If both players accept the
            claim, the claimer gets the rest of the tricks and the game moves to
            the deal summary screen.
          </p>
        </Card>
        <Card
        ...
        >
          <p>
            The 'Claim Some' feature speeds up gameplay in some scenarios by
            allowing the declarer (person playing the contract) to claim some
            number of tricks less than or equal to the number of tricks
            remaining.&nbsp; The UI guides players through the selection process
            by disabling invalid choices and displaying the choices made in a
            table.
          </p>
        </Card>
        <Card
        ...
        >
          <p>
            ...
            information is useful for self-improvement and providing feedback to
            others.
          </p>
        </Card>
        <Card
        ...
        >
          <p>
            ...
            themes, card back image, and other preferences are all customizable
            via the preferences page.
          </p>
        </Card>
        <Card video={themesVideo} cardName="queen-of-spades" title="Themes">
          <p>
            There are 8 different color themes available. Some are intentionally
            strange, while others are meant to impress.
          </p>
        </Card>
        <Card
...
export const BridgeSectionContainer = (props: BridgeSectionContainerProps) => {
    const currentBridgeSection = useSelector(currentBridgeSectionSelector);

  return (
    <div className={BRIDGE_SECTION_CONTAINER_CLASSNAME} style={{transform: `translateX(-${100 * currentBridgeSection}vw`}}>
