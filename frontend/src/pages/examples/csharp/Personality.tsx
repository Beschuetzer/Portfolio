		...
		children: [
			<React.Fragment>
				<CSharpCardSection title="The Collaborative Process">
					<ol>
						<li>We decide what we are going to work on for that day.</li>
						<li> We discuss our understanding of the problem.</li>
						<li>
							We take turns making our case for why we think what we think,
							using data/examples when possible.
						</li>
						<li>
							We reach some level of basic agreement on how the AI should behave
							in general with regards to the behavior in question.
						</li>
						<li>
							We start writing test cases to make sure we aren't missing
							anything (this is also the time when our assumptions are really
							put to the test).
						</li>
						<li>I creat the coding architecture for the feature/section.</li>
...
const Personality: React.FC<PersonalityProps> = () => {
	return (
		<CSharpLayout sections={sections} pageName={AUTO_BID_PAGE_NAME}>
			{" "}
		</CSharpLayout>
	);
};
