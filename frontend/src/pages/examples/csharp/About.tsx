            ...
            children: [
              <React.Fragment>
                ...
                <CSharpCardSection>
                  ...
                  learning new things and bring a natural curiosity to
                  everything I encounter. While I enjoy being out in the world,
                  I always look forward to evenings at home with one or two good
                  friends and great conversation. I can also find happiness on
                  my own, working on a project or reading a good book.
                </CSharpCardSection>
                <CSharpCardSection>
            ...
            children: [
              <React.Fragment>
                ...
                <CSharpCardSection title="Biking">
                  One of the most enjoyable things I do on a regular basis is
                  bike riding.&nbsp; I enjoy it so much, that I even tried using
                  it as my main source of transportation for a year (quite a
                  challenge given I did it in Minnesota).&nbsp;
                </CSharpCardSection>
                <CSharpCardSection title="Hiking">
                  Living in Oregon for two years really fostered a fondness for
                  hiking.&nbsp; I don't plan on hiking Everest anytime soon, but
                  I will definitely enjoy any chance I get to change my
                  elevation by using my feet.
                </CSharpCardSection>
                <CSharpCardSection title="Drums">
                  I've been playing drums since I was 14.&nbsp; I'm not
                  particularly great, but it's a nice way to relieve stress.
                </CSharpCardSection>
                <CSharpCardSection title="Guitar">
                  In high school, a few friends and I started a band.&nbsp; It
                  was during this time that I learned how to play guitar.&nbsp;
                  While not as naturally-inclined to it, playing guitar is
                  something I find rewarding.&nbsp;
                </CSharpCardSection>
                <CSharpCardSection title="Exercise">
                  Sort of a strange thing to put for an 'interest', but going to
                  the gym and exercising is the main way that I maintain a
                  healthy mindset.
                </CSharpCardSection>
                  ...
                  <Carousel
                    ...
                    items={[
                      ...
                      },
                      {
                        ...
                        srcThumbnail: germany05Thumbnail,
                        description:
                          "Not much left of the old city in Nuernberg",
                      },
                      {
                        srcMain: germany07,
                        srcThumbnail: germany07Thumbnail,
                        description:
                          "The pain is real even if the equipment is not",
                      },
                      {
                        srcMain: germany09,
                        srcThumbnail: germany09Thumbnail,
                        description:
                          "Shields only work if you know how to use them",
                      },
                      {
                        srcMain: p2p01,
                        srcThumbnail: p2p01Thumbnail,
            ...
            children: [
              <React.Fragment>
                ...
                <CSharpCardSection title="A Passion for Sound">
                  Music has been a big part of my life since I was young.&nbsp;
                  Ever since first discovered Fruity Loops, I have been using
                  music as a cathartic outlet.&nbsp; The songs are almost
                  universally of low quality, but the act of getting the idea
                  out of my head into the real world is really the part that
                  brings me joy.&nbsp; Listening to the song reminds me of the
                  process.&nbsp;
                </CSharpCardSection>
                ...
                <CSharpCardSection title="Real Instruments">
                  As my interest and talent grew, I began trying to learn how to
                  sing and record songs using more than just electronic samples
                  and instruments:
                  <AudioList
                    className="margin-top-1"
                    items={[
                ...
                <CSharpCardSection title="Making the Most of It">
                  For a few years, I whole-heartedly pursued the idea of
                  becoming a recording/mixing engineer.&nbsp; Unfortunately,
                  devotion doesn't always make up for lack of skill and
                  connections:
                  <AudioList
                    className="margin-top-1"
                    items={[
